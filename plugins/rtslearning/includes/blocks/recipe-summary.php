...
function up_recipe_summary_render_cb($atts, $content, $block) {
    ...
    $postTerms = is_array($postTerms) ? $postTerms : []; //ternary operator: Condition ? true : false; FONTOS!
    $cuisines = '';
...
ob_start();
?>
<div class="wp-block-rtslearning-recipe-summary">
  <i class="bi bi-alarm"></i>
  <div class="recipe-columns-2">
    <div class="recipe-metadata">
      <div class="recipe-title">
        <?php _e('Prep Time', 'rtslearning'); ?>
      </div>
